import xadmin
from .models import Device_Assets,Server_Assets,Assets,Cabinet,OS,Server_Model,Device_Model,Manager,IP_list,Device_port

class Device_AssetsAdmin(object):
    list_display=['assets','ip','name','model']
    search_fields=['ip','name','model']
    list_filter=['ip','name','model']

class Server_AssetsAdmin(object):
    list_display=['assets','ip','nic1tosw','nic2tosw','nic3tosw','nic4tosw','nic5tosw','nic6tosw','nic7tosw','nic8tosw','mgmttosw','FC01tosw','FC02tosw','mgmt_ip','mgmt_user','mgmt_password','model','os']
...
xadmin.site.register(Device_Assets, Device_AssetsAdmin)
xadmin.site.register(Server_Assets, Server_AssetsAdmin)
xadmin.site.register(Assets, AssetsAdmin)
xadmin.site.register(Cabinet, CabinetAdmin)
xadmin.site.register(OS, OSAdmin)
xadmin.site.register(Server_Model, Server_ModelAdmin)
xadmin.site.register(Manager, ManagerAdmin)
xadmin.site.register(IP_list, IP_listAdmin)
xadmin.site.register(Device_port, Device_portAdmin)
xadmin.site.register(Device_Model, Device_ModelAdmin)
